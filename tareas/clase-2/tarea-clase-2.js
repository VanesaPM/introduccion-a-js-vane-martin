...
let operador=prompt('selecciona el operador  + o - ')
let numero1=Number(prompt('elegi un numero'))
let numero2=Number(prompt('elegi otro numero'))
...
if (calcularEdad(anioActual, anioNacimiento) >= 18){
