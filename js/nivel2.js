...
let comidasFavoritas = ['helado', 'tarta de acelga', 'lemon pie', 'pechito de cerdo'];
...
*/
/*
let flores = ['rosa', 'jazmin', 'pensamiento', 'clavel'];
    console.log(flores)
flores[2] = 'orquidea'
    console.log(flores)
...
/*const colores = ['azul', 'rosa', 'celeste'];
    colores[2] = 'rojo';
...
//comidasFavoritas
/*comidasFavoritas = ["pan", "pasta"];

for (let a = 0; a < comidasFavoritas.length; a++) {
  console.log("Me gusta  " + comidasFavoritas[a]);
}
*/
/*
    Bucles y Logica
...
for (let numero = 1; numero <= 50; numero++) {
  ...
  const esMultiploDeTresYCinco = numero % (3 * 5) === 0;

  if (esMultiploDeTresYCinco) {
