...
//let variableUno
//let variableDos
//console.log('variableUno es ' + variableUno)
//console.log('variableDos es ' + variableDos)
...
//console.log(numero1, ' hola mundo ', numero2)
...
console.log('Mi edad es ' + calcularEdad(anioActual, anioNacimiento));
...
function miSueldo (salarioAnual) {
    return (salarioAnual / 12)
};
console.log('Mi sueldo Mensual es ' +  miSueldo(salarioAnual));
    
    
function miSueldoSemanal (salarioMensual) {
    return (salarioMensual / 4)
};
console.log('Mi sueldo semanal es ' + miSueldoSemanal(salarioMensual));


function miSueldoDiario (salarioMensual) {
    return (salarioMensual / 30)
};

console.log('Mi sueldo diario es ' + miSueldoDiario(salarioMensual));


function miSalarioporHora (diario) {
    return (diario / 8)
};

console.log('Mi sueldo po hora es ' + miSalarioporHora(miSueldoDiario(salarioMensual)));
